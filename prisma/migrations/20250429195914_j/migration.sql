...
INSERT INTO "new_Image" ("challengeId", "created_at", "description", "duration", "id", "updated_at", "url", "userId") SELECT "challengeId", "created_at", "description", "duration", "id", "updated_at", "url", "userId" FROM "Image";
DROP TABLE "Image";
